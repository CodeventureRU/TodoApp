...
const CreatingTaskModal = ({newTaskModalActive, setNewTaskModalActive, newTask, setNewTask, selectedTags, setSelectedTags, tags, create, setTagsManagementModalActive}) => {
    return (
